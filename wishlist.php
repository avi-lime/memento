						...
						<div class="card" style="width: 18rem; ">
							<a href="shop-details.php?product_id=<?php echo $wishlistdetails['id'] ?>">
								<img class="card-img-top" src="global/assets/images/
									...
									echo $image['image']; ?>
									" alt="<?php echo $wishlistdetails['name'] ?>" />
							</a>
							<div class="card-img-overlay">
								<a href="" style="color:white" class="delete" id="<?php echo $wishlist['id'] ?>"><i
										class="fa fa-trash" aria-hidden="true"></i></a>
							</div>
							<ul class="list-group list-group-flush">
								<li class="list-group-item" style="border:none">
									<?php echo $wishlistdetails['name'] ?>
								</li>
								<li class="list-group-item">₹
									...
									?><span style="color: #b7b7b7;font-size: 15px;font-weight: 400;margin-left: 10px;text-decoration: line-through">₹
										<?php echo $wishlistdetails['price'] ?>
									</span>
								</li>
							</ul>
							<div class="card-body">
